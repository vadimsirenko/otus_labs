...
class BanknoteTest {
    ...
    void getBanknoteSum() {
        ...
        assertEquals(expectedSum, Banknote.getBanknoteSum(banknotes));
    }
    @Test
    void getBanknoteSumAsParams() {
        int expectedSum = 6600;
        assertEquals(expectedSum, Banknote.getBanknoteSum(Banknote.N5000,Banknote.N1000,Banknote.N500,Banknote.N100));
    }
    ...
    void getSumOfNumberBanknote() {
        ...
        assertEquals(expectedSum, banknote.getSumOfNumberBanknote(banknoteNum));
    }
